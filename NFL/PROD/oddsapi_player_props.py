...
# Define Constants
#MY_BOOKMAKERS = ['fanduel', 'draftkings', 'betmgm']
MY_BOOKMAKERS = ['betmgm']
SELECTED_BOOK = 'betmgm'
ATD_DELTA = 0.01
#API_KEY = '231b63d04d723f57758d32c790e99bee'
API_KEY = '81d21adfe60b6402965439773a15f073'
